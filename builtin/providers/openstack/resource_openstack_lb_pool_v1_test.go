...
func TestAccLBV1Pool_changeMonitor(t *testing.T) {
	var monitor_1, monitor_2 monitors.Monitor
	var network networks.Network
	var pool pools.Pool
	var subnet subnets.Subnet
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccLBV1Pool_changeMonitor_1,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("openstack_networking_network_v2.network_1", &network),
					testAccCheckNetworkingV2SubnetExists("openstack_networking_subnet_v2.subnet_1", &subnet),
					testAccCheckLBV1PoolExists("openstack_lb_pool_v1.pool_1", &pool),
			...
			resource.TestStep{
				Config: testAccLBV1Pool_changeMonitor_2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2NetworkExists("openstack_networking_network_v2.network_1", &network),
					testAccCheckNetworkingV2SubnetExists("openstack_networking_subnet_v2.subnet_1", &subnet),
					testAccCheckLBV1PoolExists("openstack_lb_pool_v1.pool_1", &pool),
...
const testAccLBV1Pool_changeMonitor_1 = `
resource "openstack_networking_network_v2" "network_1" {
  name = "network_1"
  admin_state_up = "true"
}
...
const testAccLBV1Pool_changeMonitor_2 = `
resource "openstack_networking_network_v2" "network_1" {
  name = "network_1"
  admin_state_up = "true"
}
